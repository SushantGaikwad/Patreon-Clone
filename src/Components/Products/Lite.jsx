...
const Lite = () =>{
    return (
        <div>
            ...
            <div>
            <div className={style.div2_image_contents}>
                    <div>                        
                        <img src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/product-lite-02-features_2x.png" alt="" />
                    </div>
                    <div className={style.div2_contents}>
                        <span className={style.main_heading}>Membeship essentials</span>
                        <div>
                            <span className={style.span_heading}>Hosted Created Page</span><br />
                            <span className={style.span_text}>Your creator page on patreon.com is where you invite fans to become patrons, and post updates and content just for them</span>
                        </div>
                        <div>
                            <span className={style.span_heading}>Patron communication tools</span><br />
                            <span className={style.span_text}>You own the relationship with patrons. Communicate directly via email, posts on your page, or with direct messaging</span>
                        </div>
                        <div>
                            <span className={style.span_heading}>Patreon workshops</span><br />
                            <span className={style.span_text}>Learn from our Creator Success team about how to set up your page, what to offer, how to talk about Patreon, and more.</span>
                        </div>
    ...
    {/* DIv 3 */}
            ...
            <div className={style.div3}>
                    <div className={style.div3_background}>
                    ...
                    <picture className={style.Background_leftImage}><source srcset="https://c5.patreon.com/external/product/shared/product-spots-left@2x.png 2x, https://c5.patreon.com/external/product/shared/product-spots-left.png 1x" />
                            <img src="https://c5.patreon.com/external/product/shared/product-spots-left.png" />
                    </picture>
                    <picture className={style.Background_rightImage}><source srcset="https://c5.patreon.com/external/product/shared/product-spots-right@2x.png 2x, https://c5.patreon.com/external/product/shared/product-spots-right.png 1x"/>
                            <img src="https://c5.patreon.com/external/product/shared/product-spots-right.png"/>
                    </picture>
                    <div className={style.div3_image_contents}>
                      <div className={style.div3_image_contents_img}>
                          ...
                          <div>
                              <span className={style.div3_name}>Tarn  Zach, Bay 12 Games</span>
                              <span className={style.div3_creator}>Video Game Creator</span>
                          </div>
                      </div>
                      <div className={style.div3_image_contents_span} >
                      <span className={style.div3_text}>Our patrons support us because they want us to keep releasing our video game. They’re not super motivated by a huge list of benefits, so we don’t need multiple tiers. We just offer a single level of support and patrons can choose the amount. This works great for us.</span>
                      </div>
                    </div>
            </div>
            </a>
    ...
    {/* Div 4 */}
            <div className={style.div4}>
                    ...
                    <div className={style.div4_cards}>
                            ...
                            <div>
                            <span>
                            <svg viewBox="0 0 25 25" className={style.div4_svg_icon_lite}><path data-stroke="1" d="M5.5 18h-.75a3 3 0 01-3-3v-3a3 3 0 013-3h.75a.75.75 0 01.75.75v7.5a.75.75 0 01-.75.75zm15.75 0h-.75a.75.75 0 01-.75-.75v-7.5A.75.75 0 0120.5 9h.75a3 3 0 013 3v3a3 3 0 01-3 3z"></path><path data-stroke="2" d="M4.75 9A8.25 8.25 0 0113 .75 8.25 8.25 0 0121.25 9M16 21.75h2.25a3 3 0 003-3V18"></path><path data-stroke="3" d="M14.5 23.25H13a1.5 1.5 0 01-1.5-1.5 1.5 1.5 0 011.5-1.5h1.5a1.5 1.5 0 011.5 1.5 1.5 1.5 0 01-1.5 1.5z"></path><path data-stroke="4" d="M10 15.442c1.7 1.55 4.3 1.55 6 0m-6-5.457v1.312m6-1.312v1.312"></path></svg>
                                </span>
                                <span className={style.div4_cards_heading_lite}>Patron support</span><br />
                                <span className={style.div4_cards_text}>Rest easy knowing we handle your patron's questions, payments, and concerns to ensure they are taken care of.</span>
                            </div>
                            <div>
                            <span>
                            <svg viewBox="0 0 25 25" className={style.div4_svg_icon_lite}><path data-stroke="1" d="M19.454 12.1V6c0-.828-.66-1.5-1.476-1.5h-4.43m-5.904 0h-4.43c-.815 0-1.476.672-1.476 1.5v9c0 .828.661 1.5 1.477 1.5h4.429m-.738 0l-2.215 5.25m5.906-21V3"></path><path data-stroke="2" d="M17.24 14.308l-6.643 2.779 6.643 2.471 6.644-2.471-6.644-2.779z"></path><path data-stroke="3" d="M10.597 17.066v3.771m2.952-2.652V21.3a.75.75 0 00.464.7l2.953 1.2a.723.723 0 00.548 0l2.953-1.2a.748.748 0 00.464-.7v-3.115"></path><path data-stroke="4" d="M12.073 6H9.12a1.488 1.488 0 01-1.476-1.5v-.75c0-.414.33-.75.738-.75h4.429c.408 0 .738.336.738.75v.75c0 .828-.66 1.5-1.476 1.5z"></path></svg>
                                </span>
                                <span className={style.div4_cards_heading_lite}>Creator-first education</span><br />
                                <span className={style.div4_cards_text}>Learn how to effectively run your creative business with our workshops, world-class knowledge base, and creator resources.</span>
                            </div>
                            <div>
                            <span>
                            <svg viewBox="0 0 25 25" className={style.div4_svg_icon_lite}><path data-stroke="1" d="M21.233 1.157a5.234 5.234 0 00-5.967 8.283l-.656 3.779 3.423-2.111a5.133 5.133 0 003.33-.321"></path><path data-stroke="2" d="M9.437 18.75a3.375 3.375 0 100-6.75 3.375 3.375 0 000 6.75z"></path><path data-stroke="3" d="M14.663 23.243A6.062 6.062 0 004.2 23.25m15.004-9v9m-17.25 0V3.75a3 3 0 013-3h7.5m-10.5 6h9m-3-3h3M23.7 3a.375.375 0 100 .75.375.375 0 000-.75m-5.996.75v4.5m6-2.25v2.25m-6-2.25h3m0-2.25v4.5"></path></svg>
                                </span>
                                <span className={style.div4_cards_heading_lite}>Mobile app</span><br />
                                <span className={style.div4_cards_text}>Message your patrons and monitor your membership business with our native iOS and Android apps.</span>
                            </div>
                    </div>
            </div>
            ...
            <div className={style.div5}>
                    <span className={style.div5_text}>Join 200,000+ creators using Patreon today</span>
                    <a href="/"><span className={style.div5_button} >Get Started with Lite</span></a>
            </div>
        </div>
    )
}

...
const Pro = () =>{
    ...
    return (
        <div>
            ...
            <div className="div1">
                ...
                <svg height="100%" width="100%" fill="#006274"><svg viewBox="0 0 1440 600" preserveAspectRatio="none"><path d="M0 0h1440v575s-88 16-153 14c-58.04-1.786-159.94 7.931-181.09 10.031-2.65.264-5.25.399-7.91.407L921 600H0V0z" data-fill="1"></path></svg></svg>
                </div>
                <div className="div1-img-contents">
                    <div>
                        <img src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/product-pro-01-header_2x.png" alt="" />
                    </div>
                    <div className="div1-span">
                            <span className="span1">PATREON Pro</span><br />
                            <span className="span2">All the tools to master membership</span><br />
                            <span className="span3">Build a thriving membership business that provides meaningful income for you and a rewarding experience for your patrons.</span><br />
            ...
            <div className="div2-image-contents">
                    <div>                        
                        <img src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/product-pro-02-features-engage-your-patrons_2x.png" alt="" />
                    </div>
                    <div className="div2-contents">
                        <span className="main-heading">Engage your patrons</span>
                        <div>
                            <span className="span-heading">Hosted creator page</span><br />
                            <span className="span-text">Your creator page is where you invite fans to become patrons, showcase the benefits you offer, and post updates and content just for them.</span>
                        </div>
                        <div>
                            <span className="span-heading">Unlimited membership tiers</span><br />
                            <span className="span-text">Membership tiers are levels of membership with different benefits and prices. We help you optimize your tiers, and track and deliver benefits to patrons.</span>
                        </div>
                        <div>
                            <span className="span-heading">Patron communication tools</span><br />
                            <span className="span-text">You own the relationship with patrons. You can communicate with them directly via email, posts on your page, or with direct messaging.</span>
                        </div>
    ...
    {/* DIv 3 */}
            ...
            <div className="div3">
                    ...
                    <svg fill="rgb(225, 240, 250)" height="100%" width="100%"><svg preserveAspectRatio="none" viewBox="0 0 1301 449" xmlns="http://www.w3.org/2000/svg" fill="rgb(225, 240, 250)"><path d="M12 159L0 35a2 2 0 0 1 2-2l46-6 78-3 316-9 225-5 120-4 263-6h207l2 2 9 61 24 244 9 79-4 35-2 2-245 6-263 2-237 6-132 5-197 3-151 4a2 2 0 0 1-2-2v-7L12 250v-91z" data-fill="1"></path></svg></svg>
                    </div>
    ...
    {/* Div 4 */}
            <div className="div4">
                    ...
                    <div className="div4-cards">
                            ...
                            <div>
                            <span>
                            <svg viewBox="0 0 25 25" className="div4-svg-icon-pro"><path data-stroke="1" d="M19.454 12.1V6c0-.828-.66-1.5-1.476-1.5h-4.43m-5.904 0h-4.43c-.815 0-1.476.672-1.476 1.5v9c0 .828.661 1.5 1.477 1.5h4.429m-.738 0l-2.215 5.25m5.906-21V3"></path><path data-stroke="2" d="M17.24 14.308l-6.643 2.779 6.643 2.471 6.644-2.471-6.644-2.779z"></path><path data-stroke="3" d="M10.597 17.066v3.771m2.952-2.652V21.3a.75.75 0 00.464.7l2.953 1.2a.723.723 0 00.548 0l2.953-1.2a.748.748 0 00.464-.7v-3.115"></path><path data-stroke="4" d="M12.073 6H9.12a1.488 1.488 0 01-1.476-1.5v-.75c0-.414.33-.75.738-.75h4.429c.408 0 .738.336.738.75v.75c0 .828-.66 1.5-1.476 1.5z"></path></svg>
                                </span>
                                <span className="div4-cards-heading-pro">Creator-first education</span><br />

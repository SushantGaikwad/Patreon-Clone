    ...
    return (
        <div>
            ...
            <div className="div2-image-contents">
                    <div>                        
                        <img src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/premium-partnership-with-patreon.lg_1x.png" alt="" />
                    </div>
                    <div className="div2-contents">
                        <span className="main-heading">Partnership with Patreon</span>
                        <div>
                            <span className="span-heading">Influence</span><br />
                            <span className="span-text">Get early insight into upcoming product changes, early access to new features in development, and the opportunity to influence our product roadmap.</span>
                        </div>
                        <div>
                            <span className="span-heading">Opportunities</span><br />
                            <span className="span-text">We identify the right joint marketing opportunities for you to share your story - through live events, performances, speaking opportunities, PR, social, and more..</span>
                        </div>
                        <div>
                            <span className="span-heading">Invite-only Events</span><br />
                            <span className="span-text">Join a vibrant community of established creators at Patreon-sponsored events and networking opportunities. We also facilitate 1:1 introductions to other creators mutually interested in collaboration.</span>
                        </div>
            ...
            <div className="div3">
                    ...
                    <div className="div3-image-contents">
                      <div className="div3-image-contents-img">
                          <div style={{marginBottom:"20px"}}><img width="150px" src="https://live-patreon-marketing.pantheonsite.io/wp-content/uploads/2020/12/premium-avatar-peter-hollens_2x.png" alt="" /></div>
                          <div>
                              <span className="div3-name">PETER HOLLENS</span>
                              <span className="div3-creator">Musician and video creator</span>
                          </div>
                      </div>
                      <div className="div3-image-contents-span" >
                      <span className="div3-text">Patreon not only changed my life, but changed the lives of the people I employ — the 19 contractors and the full-time employees. Because of them, I’m now able to grow a digital media company and help foster this type of creation. Every musician in the world should be on this platform.</span>
                      </div>
                    </div>
            </div>
            </a>
            ...
            <div className="div4">
                    ...
                    <div className="div4-cards">
                            ...
                            <svg viewBox="0 0 25 25"  className="div4-svg-icon"><path data-stroke="1" d="M1.75.75v22.5h22.5M16.936 8.578l4.494-5.616M10.621 7.359L14.63 9.14M1.75 11.25l6.214-3.728m8.596 8.998l4.74-2.632M9.25 17.25h4.5m-12 3l4.658-2.329"></path><path data-stroke="2" d="M9.25 8.25a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm6.75 3a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm6.75-7.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm0 11.25a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm-7.5 3.75a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm-7.5 0a1.5 1.5 0 100-3 1.5 1.5 0 000 3z"></path></svg>
                                ...
                                <span className="div4-cards-heading">Business Tools</span><br />
                            ...
                            <div>
                            <span>
                            <svg viewBox="0 0 25 25" className="div4-svg-icon"><path data-stroke="1" d="M19.454 12.1V6c0-.828-.66-1.5-1.476-1.5h-4.43m-5.904 0h-4.43c-.815 0-1.476.672-1.476 1.5v9c0 .828.661 1.5 1.477 1.5h4.429m-.738 0l-2.215 5.25m5.906-21V3"></path><path data-stroke="2" d="M17.24 14.308l-6.643 2.779 6.643 2.471 6.644-2.471-6.644-2.779z"></path><path data-stroke="3" d="M10.597 17.066v3.771m2.952-2.652V21.3a.75.75 0 00.464.7l2.953 1.2a.723.723 0 00.548 0l2.953-1.2a.748.748 0 00.464-.7v-3.115"></path><path data-stroke="4" d="M12.073 6H9.12a1.488 1.488 0 01-1.476-1.5v-.75c0-.414.33-.75.738-.75h4.429c.408 0 .738.336.738.75v.75c0 .828-.66 1.5-1.476 1.5z"></path></svg>
                                </span>
                                <span className="div4-cards-heading">Creator-first education</span><br />
